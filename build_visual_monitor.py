...
tips_list = ["支付核心 CPU", "支付核心 内存", "支付核心 磁盘", "门户/认证中心 CPU", "门户/认证中心 内存",
             "门户/认证中心网络", "门户/认证中心磁盘", "核心交换机CPU", "核心交换机内存", "移动网络流量", "电信网络流量",
             "人保金服到集团核心网RT1", "人保金服到集团核心网RT2", "人保金服到华夏银行RT1", "人保金服到华夏银行RT2"]
unit_list = ["%", "MB", "GB", "%", "MB", "Kbps", "GB", "%", "%", "Kbps", "Kbps", "Kbps", "Kbps", "bps", "Kbps"]
level_list = [0.01, 0.000001, 0.000000001, 0.01, 0.000001, BPS_2_KBPS, 0.000000001, 1, 1, BPS_2_KBPS, BPS_2_KBPS,
              BPS_2_KBPS, BPS_2_KBPS, 1, BPS_2_KBPS]
page = Page()
count = 0
list_count = 1
